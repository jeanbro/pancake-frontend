  ...
  return (
    <StyledActionPanel expanded={expanded}>
      <InfoSection>
        ...
        <Flex mb="8px" justifyContent={['flex-end', 'flex-end', 'flex-start']}>
          <LinkExternal style={{ color: '#102648' }} href={earningToken.projectLink} bold={false}>
            {t('View Project Site')}
          </LinkExternal>
        </Flex>
        {poolContractAddress && (
        ...
        {account && isMetaMaskInScope && tokenAddress && (
          <Flex mb="8px" justifyContent={['flex-end', 'flex-end', 'flex-start']}>
            ...
            >
              <Text color="#102648">{t('Add to Metamask')}</Text>
              <MetamaskIcon ml="4px" />
            </Button>
          </Flex>
        )}
        ...
        <span ref={tagTargetRef}>
          <HelpIcon ml="4px" width="20px" height="20px" color="#102648" />
        </span>
      </InfoSection>
      <ActionContainer>
        {showSubtitle && (
          <Text mt="4px" mb="16px" color="#102648">
