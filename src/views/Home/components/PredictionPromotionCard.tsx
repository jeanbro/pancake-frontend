  ...
  return (
    <StyledPredictionCard>
      <CardBody>
        ...
        <PredictionOver bold color="#007bff">
          {over}
        </PredictionOver>
        {bnbWonInUsd ? (
          <PredictionWon mb="24px" color="#007bff" bold prefix="$" decimals={0} value={bnbWonInUsd} />
        ) : (
          <>
        ...
        <Link href="https://pancakeswap.finance/prediction" id="homepage-prediction-cta">
          <Button style={{ backgroundColor: '#007bff' }} px={['14px', null, null, null, '20px']}>
            <PredictionTryNow>
